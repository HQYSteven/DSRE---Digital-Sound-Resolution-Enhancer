...
class MainWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        # ==================== Linux适配点4：图标路径处理 ====================
        # Linux下Qt支持ico/png，建议将logo.ico替换为logo.png（可选）
        icon_path = os.path.join(os.path.dirname(__file__), "logo.ico")
        # 兼容：如果ico文件不存在，跳过设置图标
...
# ==================== Linux适配点5：移除Windows专属API ====================
def main():
    # 移除Windows下的ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID调用
    # Linux无此API，无需替换
